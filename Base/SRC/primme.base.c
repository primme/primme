...
int @(pre)primme(double *evals, SCALAR *evecs, double *resNorms, 
   ...
   CHKERR(main_iter_@(pre)primme(evals, perm, evecs, resNorms, machEps, 
...
static int allocate_workspace(primme_params *primme, int allocate) {
   ...
   CHKERR(init_basis_@(pre)primme(NULL, primme->nLocal, 0, NULL, 0, NULL, 0,
   ...
   CHKERR(ortho_@(pre)primme(NULL, 0, NULL, 0, primme->maxBasisSize,
   ...
   CHKERR(solve_H_@(pre)primme(NULL, primme->maxBasisSize, 0, NULL, 0, NULL, 0,
   ...
   CHKERR(solve_correction_@(pre)primme(NULL, NULL, NULL, NULL, NULL, 
   ...
   CHKERR(restart_@(pre)primme(NULL, NULL, primme->nLocal, primme->maxBasisSize,
   ...
   CHKERR(update_projection_@(pre)primme(NULL, 0, NULL, 0, NULL, 0, 0, 0,
            primme->maxBasisSize, NULL, &realWorkSize, 0, primme), -1);

   CHKERR(prepare_candidates_@(pre)primme(NULL, NULL, primme->nLocal, NULL, 0,
   ...
   CHKERR(retain_previous_coefficients_@(pre)primme(NULL, 0, NULL, 0, NULL, 0,
