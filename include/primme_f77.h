...
C      * Neither the name of College of William & Mary nor the
...
C  DISCLAIMED. IN NO EVENT SHALL COLLEGE OF WILLIAM & MARY BE LIABLE FOR ANY
...
C  File: primme_f77.h
C  
C  Purpose - Main header with the PRIMME F77 interface functions.
C  
C******************************************************************************
