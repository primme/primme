...
int main_iter_dprimme(double *evals, int *perm, double *evecs, 
   ...
   while (!converged &&
      ...
      while (numConverged < primme->numEvals &&
         ...
         if (!primme->locking) {
            double *X, *R;
            ret = restart_dprimme(&restartSize, V, W, primme->nLocal, basisSize,
            ...
            double *X, *R;
            ret = restart_locking_dprimme(&restartSize, V, W, primme->nLocal, basisSize,
               primme->nLocal, &X, &R, hVecs, basisSize, hVecsperm, hVals, flags, iev, &blockSize,
...
int prepare_candidates(double *V, double *W, int nLocal, int basisSize,
