...
int restart_dprimme(double *V, double *W, int nLocal, int basisSize,
   ...
   *reset = 0;
   ...
   restart_projection_dprimme(V, ldV, W, ldV, H, ldH, Q, ldQ, nLocal, R,
...
static int restart_refined(double *V, int ldV, double *W, int ldW, double *H,
      ...
      double *hU, int ldhU, int newldhU, int indexOfPreviousVecsBeforeRestart,
   ...
   double *hVecsRot0;  /* Part of hVecsRot                                   */
   double *RPrevhVecs;
   double *rwork0;
   int rworkSize0;
   int *restartPerm0;
   ...
   ret = ortho_dprimme(hVecsRot0, mhVecsRot0, R, ldR, 0, nRegular-1, NULL,
   ...
   ret = ortho_dprimme(hU, basisSize, R, ldR, nRegular,
...
static int ortho_coefficient_vectors_dprimme(double *hVecs, int basisSize,
      ...
      int ldR, int *numPrevRetained, double *outR, int ldoutR, double machEps,
   ...
   ret = ortho_dprimme(hVecs, ldhVecs, !outR ? NULL :
