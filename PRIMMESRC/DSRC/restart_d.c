...
static int restart_refined(double *V, int ldV, double *W, int ldW, double *H,
   ...
   Num_gemm_dprimme("N", "N", basisSize, numPrevRetained, basisSize, tpone,
   ...
   /* hU = hU * hVecsRot0 */
   Num_gemm_dprimme("N", "N", basisSize, nRegular, mhVecsRot0, tpone, hU,
...
static int ortho_coefficient_vectors_dprimme(double *hVecs, int basisSize,
   ...
   int ret, i;
   double tpone = +1.0e+00;             /*constants*/
