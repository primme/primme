...
int restart_locking_dprimme(int *restartSize, SCALAR *V, SCALAR *W, 
   ...
   if (V == NULL) {
      ...
      *rworkSize = max(*rworkSize, (size_t)
            Num_compute_residual_columns_dprimme(nLocal, NULL, NULL,
               basisSize, NULL, 0, NULL, 0, NULL, primme->maxBlockSize, 0, 0,
               NULL, 0, NULL, primme->maxBlockSize, NULL, 0, NULL, 0, NULL, 0));
      CHKERR(Num_reset_update_VWXR_dprimme(NULL, NULL, nLocal, basisSize,
   ...
   *R = &W[*restartSize*ldV];
   ...
   CHKERR(check_convergence_dprimme(&V[ldV*left],
