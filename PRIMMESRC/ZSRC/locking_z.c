...
int restart_locking_zprimme(int *restartSize, Complex_Z *V, Complex_Z *W,
   ...
   *restartSize += numPacked + *numPrevRetained;
   ...
   /*                                                                */
   /*      non-locked | prevRitzVecs | to be locked | X & R          */
   /* V: [------------|--------------|--------------|- X ---|    )   */
   /* W: [------------|--------------|--------------|- R ---|    )   */
   /*                 ^ indexOfPreviousVecs                          */
   /*                                ^ left         ^ restartSize    */
   ...
   sizeBlockNorms = min(maxBlockSize, *indexOfPreviousVecs);
   ...
   *R = &W[*restartSize*ldV];
   ...
   if (1 /* Put zero to disable the new feature */) {
      ...
      /* After this operation (modified part indicated with ---)        */
      /*                                                                */
      /*      non-locked | prevRitzVecs | failed locked | X & R         */
      /* V: [            |              |---------------|- X ---|    )  */
      /* W: [            |              |---------------|- R ---|    )  */
      /*                                ^ left                          */
      /*                         failed [---------------)               */
      ...
      Num_compute_residual_columns_zprimme(nLocal, &hVals[left], &V[left*ldV], failed, ifailed, 
            ldV, &W[left*ldV], ldV,
