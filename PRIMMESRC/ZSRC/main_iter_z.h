...
int prepare_candidates_zprimme(Complex_Z *V, Complex_Z *W, int nLocal, Complex_Z
      *H, int ldH, int basisSize, int ldV, Complex_Z *X, Complex_Z *R, Complex_Z
      *hVecs, int ldhVecs, double *hVals, double *hSVals, int *flags, int
      ...
      maxBlockSize, Complex_Z *evecs, int numLocked, double *evals, double
      *resNorms, int targetShiftIndex, double machEps, int *iev, int
      *blockSize, int *recentlyConverged, int *numArbitraryVecs, Complex_Z
