...
int zprimme(double *evals, Complex_Z *evecs, double *resNorms, 
   ...
   permute_vecs_z(&evecs[primme->numOrthoConst], primme->nLocal,
...
static int allocate_workspace(primme_params *primme, int allocate) {
   ...
   if (primme->locking) {
      restartSize = restart_locking_zprimme(&primme->maxBasisSize, NULL,
      ...
      restartSize = restart_zprimme(&primme->maxBasisSize, NULL, NULL,
   ...
   restartSize += after_restart_zprimme(NULL, 0, NULL, 0, NULL, 0, NULL, 0, 0,
         NULL, 0, NULL, 0, 0,
   ...
   mainSize = max(
         ...
         prepare_candidates_z(NULL, NULL, primme->nLocal, primme->maxBasisSize,
