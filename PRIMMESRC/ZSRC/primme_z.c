...
int zprimme(double *evals, SCALAR *evecs, double *resNorms, 
   ...
   CHKERR(main_iter_zprimme(evals, perm, evecs, resNorms, machEps, 
...
static int allocate_workspace(primme_params *primme, int allocate) {
   ...
   CHKERR(init_basis_zprimme(NULL, primme->nLocal, 0, NULL, 0, NULL, 0,
   ...
   CHKERR(ortho_zprimme(NULL, 0, NULL, 0, primme->maxBasisSize,
   ...
   CHKERR(solve_H_zprimme(NULL, primme->maxBasisSize, 0, NULL, 0, NULL, 0,
   ...
   CHKERR(solve_correction_zprimme(NULL, NULL, NULL, NULL, NULL, 
   ...
   CHKERR(restart_zprimme(NULL, NULL, primme->nLocal, primme->maxBasisSize,
   ...
   CHKERR(update_projection_zprimme(NULL, 0, NULL, 0, NULL, 0, 0, 0,
            primme->maxBasisSize, NULL, &realWorkSize, 0, primme), -1);

   CHKERR(prepare_candidates_zprimme(NULL, NULL, primme->nLocal, NULL, 0,
   ...
   CHKERR(retain_previous_coefficients_zprimme(NULL, 0, NULL, 0, NULL, 0,
