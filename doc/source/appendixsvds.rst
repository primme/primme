...
.. c:type:: primme_svds_params
   ...
   .. c:member:: double *targetShifts
      ...
      Used only when |Starget| is |primme_closest_abs|.
      ...
      finding the i-th singular value.
   ...
   .. c:member:: int printLevel
      ...
      level of the underneath eigensolvers. See |printLevel|.
   ...
   .. c:member:: int initSize
    ...
    .. c:member:: int numOrthoConst
      ...
      The left and the right vector constrains are provided in the first 2x|SnumOrthoConst| vectors of
      the ``svecs`` argument in :c:func:`dprimme_svds` and :c:func:`zprimme_svds`, and must be orthonormal.
