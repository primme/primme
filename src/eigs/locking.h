...
int restart_locking_zprimme(int *restartSize, PRIMME_COMPLEX_DOUBLE *V, PRIMME_COMPLEX_DOUBLE *W,
      ...
      int *iev, int *ievSize, double *blockNorms, PRIMME_COMPLEX_DOUBLE *evecs, double *evals,
      int *numConverged, int *numLocked, double *resNorms, int *evecsperm,
      int numPrevRetained, int *indexOfPreviousVecs, int *hVecsPerm,
      int reset, double machEps, PRIMME_COMPLEX_DOUBLE *rwork, size_t *rworkSize, int *iwork,
      int iworkSize, primme_params *primme);
...
int restart_locking_cprimme(int *restartSize, PRIMME_COMPLEX_FLOAT *V, PRIMME_COMPLEX_FLOAT *W,
      ...
      int *iev, int *ievSize, float *blockNorms, PRIMME_COMPLEX_FLOAT *evecs, float *evals,
      int *numConverged, int *numLocked, float *resNorms, int *evecsperm,
      int numPrevRetained, int *indexOfPreviousVecs, int *hVecsPerm,
      int reset, double machEps, PRIMME_COMPLEX_FLOAT *rwork, size_t *rworkSize, int *iwork,
      int iworkSize, primme_params *primme);
#endif
