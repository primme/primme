...
class primme_svds_params(_object):
    ...
    if _newclass:
        numTargetShifts = _swig_property(_Primme.primme_svds_params_numTargetShifts_get, _Primme.primme_svds_params_numTargetShifts_set)
    ...
    if _newclass:
        targetShifts = _swig_property(_Primme.primme_svds_params_targetShifts_get, _Primme.primme_svds_params_targetShifts_set)
...
class PrimmeParams(primme_params):
    ...
    if _newclass:
        __kind = _swig_property(_Primme.PrimmeParams___kind_get, _Primme.PrimmeParams___kind_set)
...
class PrimmeSvdsParams(primme_svds_params):
    ...
    if _newclass:
        __kind = _swig_property(_Primme.PrimmeSvdsParams___kind_get, _Primme.PrimmeSvdsParams___kind_set)
